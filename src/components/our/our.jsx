  ...
  return (
    <div className="aos-init aos-animate" data-aos={item.id % 2 === 0 ? 'fade-right' : 'fade-left'} data-aos-duration='1500' key={item.id}>
      ...
      >
        ...
        <p className="text-arapawa text-xl font-semibold pb-3 border-b-2 mb-2 border-[#DEDDDD]">{item.name}</p>
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
                <span className="text-[#B8B8B8] font-semibold text-sm line-through">{item.subprice}</span>
