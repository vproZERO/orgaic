...
const Blog = ({ item }) => {
  return (
    <div
      key={item.id}
      className="w-[677px] h-[592px] relative aos-init aos-animate"
    ...
    >
      ...
      <div className="w-[613px] absolute h-[330px] px-[57px] pt-[46px] pb-[60px] bg-white rounded-[30px] z-20 mt-[-240px] left-[32px] shadow-2xl">
        ...
        <p className="text-city font-normal text-lg max-w-[440px] mb-4">
          {item.text}
        </p>
        <Link to={`/blog`}>
          <Button icon={<ButtonArrow />} variant="secondary">
            Read More
          </Button>
        </Link>
      </div>
