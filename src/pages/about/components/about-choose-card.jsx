...
const AboutChooseCard = ({ item }) => {
  return (
    <div
      key={item.id}
      className="bg-white rounded-[30px] aos-inti aos-animate pt-[50px] pb-[19px] px-[38px]"
    ...
    >
      ...
      <h3 className="text-arapawa font-extrabold text-2xl text-center mb-3">
        {item.title}
      </h3>
      <p className="text-center text-city max-w-[184px] mx-auto font-nromal text-lg">
        {item.text}
      </p>
    </div>
  );
